...
| Monitor dry-run #12 | Waiter armed 10:09Z: 10-min quiet window + 60 s recheck for late-ingested crashes, then dispatch, then canary c7 on green. 11 dry-runs so far: 1 pass (#6), 10 freezes, none on a real fleet-health regression. | Cascade gaps since 09:00: 31, 2.9, 5.1, 16.1, 4.0 min (median 5); a 15-min clean window is ~28% per attempt at this rate. | |
