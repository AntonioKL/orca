...
| Monitor dry-run #11 | Dispatched 10:06:20Z; c8 and c20 crashed 10:05:54, 3 s before the waiter's quiet check passed (log ingestion lag). Expected to freeze on their probes. Next waiter: 10-min window, 60 s ingestion lag. Was armed 09:58Z; holds until 6 clean min (last crash 09:59:21). Cascade gaps since 09:00: 31, 2.9, 5.1, 16.1, 4.0 min (median 5); a 15-min clean window is ~28% per attempt at this rate. | |
