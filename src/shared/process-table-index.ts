// Correlation indexes derived from a captured process table. Generic over the row
// shape so the POSIX `ps` and Windows captures share one pass rather than two.
