...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'completed means the mutation landed and --retry-request replays the recorded outcome instead of starting a second one. pending means Orca restarted mid-mutation; replay with --retry-request.',
