...
// replay path ever joins against it. Adding it needs no `user_version` bump: a
// new table is invisible to a reader that does not name it, and every open runs
// the `IF NOT EXISTS` statements below.
