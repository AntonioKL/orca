...
export type CreateMainWindowOptions = {
  ...
  /** Answers whether the daemon owns fresh persistent local PTYs, so a quit that hands them over may skip the running-process warning. Absent/throwing reads as "no". */
