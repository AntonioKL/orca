...
// v38 reports deferred startup state when reattaching after a client restart.
export const PROTOCOL_VERSION = 38
export const DEFERRED_STARTUP_STATE_DAEMON_PROTOCOL_VERSION = 38
export const DEFERRED_STARTUP_DAEMON_PROTOCOL_VERSION = 37
